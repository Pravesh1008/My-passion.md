...
|6 |**DISPLAY THE OUTPUT using configuration file** |I used the source of configuration file in the script and run the script  |Script should be run and display the output |**PASS** | ![required](https://user-images.githubusercontent.com/82143446/116287751-61175800-a7ae-11eb-96e3-9e60e9bf9999.png)| 
